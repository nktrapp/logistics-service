package br.furb.logistics.infrastructure.integration.viacep;

import br.furb.logistics.domain.model.CepInfo;
import br.furb.logistics.domain.port.CepLookupPort;
import br.furb.logistics.infrastructure.integration.cache.RedisCepCacheAdapter;
...
public class ViaCepClient implements CepLookupPort {
